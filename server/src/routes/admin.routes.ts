...
router.post('/reports', verificationRequired, passwordRequired, (req, res) => controller.createReport(req, res));
  ...
  router.get('/announcements', adminMiddleware, (req, res) => controller.listAnnouncements(req, res));
  router.post('/announcements/remove', adminMiddleware, (req, res) => controller.removeAnnouncements(req, res));
