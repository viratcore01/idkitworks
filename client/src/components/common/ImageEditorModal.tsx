...
export default function ImageEditorModal({ file, title = 'Edit photo', aspects = [{ label: 'Free', value: null }], maxOutputPx = 1600, onCancel, onDone }: Props) {
  ...
  const iconBtn = 'w-10 h-10 rounded-full bg-white border-nb-2 border-nb-black flex items-center justify-center hover:bg-nb-lime/50 active:translate-y-[1px] transition-colors';
    ...
    <div className="fixed inset-0 z-[90] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={onCancel}>
      <div className="nb-card bg-white p-4 sm:p-5 max-w-2xl w-full" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={onCancel} className="text-gray-500 hover:text-nb-black" title="Cancel">
        ...
        {fatal ? (
          <div className="text-center py-10 px-4">
            <p className="text-sm text-nb-orange font-medium">{fatal}</p>
          ...
          <>
            <div className="flex justify-center">
              <canvas
                ...
                className="rounded-nb touch-none cursor-grab active:cursor-grabbing border-nb-2 border-nb-black shadow-nb-sm"
              ...
              <div className="flex justify-center gap-2 mt-3">
                {aspects.map((a, i) => (
                  <button
                    ...
                    className={`px-3 py-1 text-xs font-display font-semibold rounded-full border-nb-2 transition-colors ${
                      i === aspectIdx ? 'bg-nb-black text-white border-nb-black' : 'bg-white border-gray-300 text-gray-600 hover:border-nb-orange'
                    }`}
                  >
                    {a.label}
                  </button>
            ...
            <div className="flex items-center justify-center gap-2 mt-4 flex-wrap">
              ...
              <input
                ...
                className="w-32 sm:w-44 accent-nb-orange"
                title="Zoom"
              />
