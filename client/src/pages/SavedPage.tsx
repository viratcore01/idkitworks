...
export default function SavedPage() {
 ...
 <div className="w-11 h-11 bg-nb-peri/15 flex items-center justify-center shrink-0">
 <Bookmark size={22} className="text-nb-peri" fill="currentColor" />
 </div>
 <div>
 ...
 <Link to="/home" className="hover:text-nb-violet">Back to feed</Link>
 </p>
 </div>
 );
}
