  ...
  return (
    <div className="max-w-3xl mx-auto p-4 sm:p-6">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-11 h-11 rounded-xl bg-nb-orange/15 flex items-center justify-center shrink-0">
          <GraduationCap size={22} className="text-nb-orange" />
        </div>
        <div>
      ...
      {error && <p className="nb-card p-3 mb-4 text-sm text-nb-orange">{error}</p>}
