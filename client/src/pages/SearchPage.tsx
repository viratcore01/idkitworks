...
export default function SearchPage() {
 ...
 return (
 <div>
 <h1 className="font-display font-bold text-2xl text-ink mb-4 flex items-center gap-2">
 ...
 <Heart size={12} strokeWidth={2.5} className={post._count.likes > 0 ? 'text-nb-pink fill-current' : ''} /> {post._count.likes}
 </span>
 <span className="inline-flex items-center gap-1">
