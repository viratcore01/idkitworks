...
export default function AuthLayout() {
 ...
 <Zap size={14} strokeWidth={2.5} className="text-nb-yellow" fill="currentColor" />
 <div className="h-1 flex-1 bg-nb-yellow " />
 </div>
 </div>
 ...
 Made with <Zap size={11} strokeWidth={2.5} className="inline mx-0.5 -mt-0.5 text-nb-violet" fill="currentColor" /> for students, by students
 </p>
 </div>
 </div>
 </div>
